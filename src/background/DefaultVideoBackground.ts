...
export default class DefaultVideoBackground
   ...
   */
  chooseNewInnerDevice(newDevice: Device): DefaultVideoBackground {
    const newTransformDevice = new DefaultVideoBackground(
      this.logger,
      newDevice,
      this.processors,
   ...
   */
  async transformStream(mediaStream?: MediaStream | any): Promise<MediaStream> {
